...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "processType":null, "taskName":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "appliesTo":"SAMPLE_TEXT", "datecompletion":"2020-01-01T00:00:00.000Z", "status":null, "priority":null}""")).asJSON
            .check(status.is(201))
